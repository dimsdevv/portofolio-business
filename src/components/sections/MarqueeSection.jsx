export default function MarqueeSection() {
  ...
  return (
    <div className="bg-[var(--color-signal)] h-12 flex items-center overflow-hidden border-y border-[var(--color-ink)] w-full relative">
      <div className="whitespace-nowrap flex group cursor-default relative w-full">
